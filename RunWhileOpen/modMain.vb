...
Module modMain
    ...
    Sub Main()
        ...
        If Environment.GetCommandLineArgs().Count > 1 Then
            ...
            ElseIf exe.ToLower = "-m" Then ' We are processing multiple file executable names
                Select Case Environment.GetCommandLineArgs(2).ToLower()
                    Case "any", "1", "*"
                        matching = 1
                    Case "one", "2"
                        matching = 2
                End Select
                Dim allValues() As String = Environment.GetCommandLineArgs()
                Array.Copy(Environment.GetCommandLineArgs, exes, Environment.GetCommandLineArgs.Length)
            End If
        Else
